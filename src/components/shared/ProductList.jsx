  ...
  return (
    <>
      {products
        ...
        .map((product) => (
        <div className="group text-center bg-gray-50 rounded-lg p-2" key={product.id}>
          ...
          <div className="">
            ...
            <button 
              ...
              type="button" 
              className="underline float-left bg-opacity-75 py-2 px-4 rounded-md text-sm text-white-900"
            >
              Quick View
            </button>              
            <Link to={`/product/${product.id}`} 
              type="button" 
              className="underline float-right bg-opacity-75 py-2 px-4 rounded-md text-sm text-white-900"
            >
              Details
            </Link>                    
          </div>
